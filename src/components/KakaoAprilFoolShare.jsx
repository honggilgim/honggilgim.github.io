...
import './KakaoAprilFoolShare.css'

const KAKAO_JS_KEY = '7e088b2b260058e76290d8df94382022'
const TEMPLATE_ID = 131294
...
export function KakaoAprilFoolShare() {
  ...
  const sendFoolMessage = useCallback(() => {
  ...
  return (
    <div className="kakao-aprilfool">
      <h2>홍길의 만우절 공유</h2>
      <p>만우절 카톡 송금하기 버튼 훼이크 공유드립니다~</p>
      {loadError && (
        <p className="kakao-aprilfool__err">
          카카오 SDK를 불러오지 못했습니다. 네트워크와 브라우저 설정을 확인해 주세요.
        </p>
      )}
      <button
        type="button"
        className="kakao-aprilfool__btn"
